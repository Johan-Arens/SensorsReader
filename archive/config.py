...
if bool(NewConfig) is True:
  ...
  print "<html>"
  print "<head>"
  print "<meta http-equiv=\"refresh\" content=\"3;url=config.py\" />"
  ...
  if configReadOK is True:
    ...
    for SensorNumber in range(1,8):
      optionLine = "Sensor Type : <select name = \"Sensors[" + str(SensorNumber) + "][Sensor_Type]\"> <option value \"\" selectedNone ></option><option value=\"DHT22\" selectedDHT22 >DHT22</option> <option value=\"1-Wire\" selected1wire >1-Wire</option></select> <br>"
      try:
  ...
  print "<input type = \"submit\" value = \"Apply Config\" /><br>"
  print "<br>"
  
  print "</form>"
  print "</td><td align=\"left\">"
  print "Raspberry PI 2/3 Pin Out mapping"
