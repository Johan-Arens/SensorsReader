...
def on_message(client, userdata, message):
    ...
    #{"Sensor_Name": "Row1_Hot", "Sensor_Address": "345345", "Timestamp": 1528550030, "Humidity": 0, "Sensor_Type": "1-Wire", "Sensor_Location": "1-Wire_sensor2", "Temperature": "22"}
...
if not configOK:
     ...
     print "<form method=\"post\" action=\"/config.py\"><button type=\"submit\">Create Config</button></form>"
     ...
     while current <= len(configReadJson['Sensors']):
          ...
          print "<hr>"
          current +=1
     print "<form method=\"post\" action=\"/config.py\"><button type=\"submit\">Edit Config</button></form>"
